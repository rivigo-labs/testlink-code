    ...
    <div id="settings" class="x-panel-body exec_additional_info" style="padding-top: 3px;overflow: visible;">
      ...
      {if $control->settings.setting_testplan}
        <tr>
          ...
          <td style="max-width: 294px;min-width: 200px;">
  ...
  <div id="filters" class="x-panel-body exec_additional_info" style="padding-top: 3px;overflow: visible;">
    ...
    {if $control->filters.filter_keywords}
      <tr>
        ...
        <td style="max-width: 294px;min-width: 200px;"><select class="chosen-select" name="filter_keywords[]"
    ...
    {if $control->filters.filter_platforms}
      <tr>
        ...
        <td style="max-width: 294px;min-width: 200px;"><select class="chosen-select" name="filter_platforms[]"
                    title=""
                    multiple="multiple"
  ...
  {if $control->filters.filter_result}
    ...
    <tr><td>&nbsp;</td></tr> {* empty row for a little separation *}
      ...
      <tr id="filter_result_build_row">
        <td>{$labels.build}</td>
        <td style="max-width: 294px;min-width: 200px;"><select class="chosen-select" id="filter_result_build" name="filter_result_build">
